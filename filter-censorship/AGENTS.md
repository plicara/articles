# Working in Filter censorship public evidence

This project directory owns its code, evidence, and lab context. Read `.plicara/README.md` and `.plicara/project.yaml` before substantive work. Use the repository's setup/check entrypoints and the local README for experiment-specific commands.
